...
<body>
<nav class="navbar navbar-expand-lg navbar-dark navbar-gradient shadow p-3 mb-5 bg-body rounded">
  <a class="navbar-brand ms-2 text-dark" href="#"><span>Muxxx Showroom <i style="color: black;  font-weight: bold;" class="fas fa-car-alt"></i></span></a>
  ...
  <div class="container">
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 "> 
        <li class="nav-item">
          <a class="nav-link me-5" href="../adminpanel">Home</a>
        </li>
        ...
        <li class="nav-item">
          <a class="btn btn-outline-danger  border border-2 btn-logout" href="logout.php">Logout</a>
        </li>
      </ul>
    </div>
  </div>
